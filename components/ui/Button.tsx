...
const buttonVariants = cva(
	'inline-flex items-center justify-center transition-colors disabled:pointer-events-none',
	{
		variants: {
			variant: {
				primary:
					'rounded-sm bg-foreground font-medium uppercase tracking-wider text-card hover:bg-foreground/90',
				outline:
					'rounded-sm border border-foreground font-medium uppercase tracking-wider text-foreground hover:bg-foreground hover:text-card',
				...
				subtle:
					'rounded-sm border border-border text-foreground hover:bg-accent',
