...
import type { CompareSpecRow, CompareSpecSection } from '@/entities/spec/model/types'
		...
		<div className={cn('divide-y divide-border', className)}>
			{sections.map(section => (
				<div key={section.title} className='py-4 md:py-6'>
					<h3 className='mb-3 text-sm font-semibold tracking-widest text-foreground md:mb-4 md:text-base'>
						{section.title}
					</h3>
