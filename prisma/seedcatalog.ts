...
### По Мозырю
- Бесплатно при любом заказе
- Срок доставки: 1–2 рабочих дня

### По Беларуси
- Бесплатно при заказе от 400 BYN
- При заказе до 400 BYN — 100 BYN
- Самовывоз — бесплатно
...
Сеть «Аура Света» работает в Мозыре и ближайших городах. В магазинах можно посмотреть популярные модели светильников, получить консультацию и оформить заказ с доставкой.
...
- **Что представлено:** люстры, потолочные светильники, бра, споты

## Магазин №2 — Торговый зал «Свет и Декор»

- **Адрес:** г. Мозырь, ул. Притыцкого, 12
- **Телефон:** +375 (33) 456-78-90
- **Режим работы:** Пн–Сб 10:00–20:00, Вс 10:00–18:00
- **Что представлено:** трековые системы, декоративный свет, лампы и электротовары

## Самовывоз и резерв

Вы можете оформить заказ онлайн и выбрать самовывоз из удобного магазина. Резерв товара держится до 48 часов после подтверждения менеджером.

## Консультация в зале

Наши специалисты помогут:

- подобрать освещение под площадь и высоту потолков;
- рассчитать количество света для конкретной комнаты;
- выбрать совместимые лампы, диммеры и аксессуары.
...
Для быстрого подбора подготовьте фото помещения или план — это ускорит консультацию и повысит точность рекомендаций.`,
	...
	},
	{
		...
		slug: 'warranty',
		content: `# Возврат и гарантия

## Гарантия на товары

Все товары в нашем магазине поставляются официальных производителей и имеют гарантию производителя:

- **Люстры, светильники, бра, споты:** 24–36 месяцев
- **Лампочки и галогенные лампы:** 12–24 месяца
- **Электротовары (розетки, выключатели, диммеры):** 36 месяцев
- **Трековые системы:** 24 месяца
- **Электронные компоненты (блоки питания, трансформаторы):** 12 месяцев

Гарантия включает производственные дефекты и неисправности. Износ, механические повреждения и неправильная установка не покрываются.

## Порядок возврата

### В течение 14 дней

Вы можете вернуть товар в первоначальном виде:

1. **Состояние товара** — упаковка целая, товар не использован
2. **Комплектность** — все части, документы, пломбы на месте
3. **Срок** — не позже чем через 14 дней со дня покупки

**Возвращаемая сумма:** полная стоимость товара минус стоимость доставки

### После 14 дней — рекламация

Если товар неработающий или неисправный:

1. **Свяжитесь** с менеджером по телефону +375 (29) 123-45-67
2. **Опишите проблему** и при возможности приложите фото/видео
3. **Получите RMA номер** для отправки товара на экспертизу
4. **Пошлите товар** в магазин (доставка за Вашу счёт)
5. **Получите решение** — ремонт, замена или возврат средств

## Возврат при заказе через интернет

- Срок отправки обратно: **1–3 рабочих дня** после получения товара
- Способ: курьер, почта, самовывоз (обговорите с менеджером)
- Стоимость доставки обратно может быть возмещена в случае брака

## Что мы не возвращаем

- Товар, использованный более одного раза
- Товар с признаками эксплуатации, загрязнения, царапин
- Светильники без оригинальной упаковки
- Кабели и провода, если вскрыта упаковка
- Товар без чека/квитанции при покупке оптом
...
Все вопросы решаем в пользу клиента. Напишите или позвоните — поможем быстро.`,
	...
	},
	{
		...
		slug: 'how-to-choose',
		content: `# Как выбрать правильное освещение

## Шаг 1: Определите тип помещения

### Гостиная
- **Основной свет:** люстра мощностью 150–200 Вт эквивалента или трековые системы
- **Дополнительный свет:** бра по сторонам дивана, напольный торшер
- **Атмосферный свет:** встраиваемые споты по периметру, декоративные светильники
- **Цветовая температура:** 2700–3000K (тёплый свет)

### Спальня
- **Основной свет:** потолочный светильник 100–150 Вт эквивалента
- **Ночной свет:** диммируемые бра по обе стороны кровати, ночник
- **Цветовая температура:** 2700K (тёплый, расслабляющий свет)

### Кухня
- **Основной свет:** встраиваемые споты или трек-система (600–800 люмен)
- **Рабочая подсветка:** светильники над столешницей и раковиной
- **Цветовая температура:** 4000K (нейтральный свет для готовки)

### Ванная
- **Основной свет:** потолочный светильник 150–200 люмен
- **Подсветка зеркала:** бра с обеих сторон по 40–60 люмен
- **Защита:** IP44 минимум (водо- и пыленепроницаемость)
- **Цветовая температура:** 4000–5000K

### Коридор и прихожая
- **Основной свет:** встраиваемые споты или трековые светильники
- **Подсветка:** светильники на нижнем уровне для ночной навигации
- **Мощность:** 5–15 люмен на квадратный метр

## Шаг 2: Рассчитайте яркость

**Формула:** 10–15 люмен на квадратный метр на 1 точку света.

**Примеры:**
- Гостиная 25 м² нуждается в 250–375 люмен основного света (3–4 люстры по 80–100 люмен или 1 люстра на 300 люмен)
- Кухня 12 м² нуждается в 120–180 люмен (3–4 встраиваемых спота по 50 люмен или 1 трек-система)

## Шаг 3: Выберите цвет света

- **2700K (тёплый)** — гостиная, спальня, уютные пространства
- **3000K (тёпло-белый)** — кухня, офис, рабочие зоны
- **4000K (нейтральный)** — кухня, ванная, ванные комнаты
- **5000K+ (холодный)** — офис, гараж, производство (не рекомендуется дома)

## Шаг 4: Выберите тип светильника

### Люстры
- Подходят для высоких потолков (выше 2,8 м)
- Дают мягкий рассеянный свет
- Популярны в классических и современных интерьерах

### Встраиваемые точечные светильники
- Идеальны для натяжных потолков
- Позволяют точечно освещать нужные зоны
- Требуют 3–5 светильников на среднее помещение

### Трековые системы
- Гибкий вариант для офисов и выставочных пространств
- Легко переориентировать лучи света
- Подходят для выделения картин, полок, витрин

### Бра и торшеры
- Идеальны для локального света рядом с кроватью, диваном, письменным столом
- Не требуют монтажа в потолок
- Помогают создать уютную атмосферу

## Шаг 5: Учтите стиль интерьера

- **Классический** → люстры с хрусталем, бронзовые бра
- **Минимализм** → встраиваемые споты, геометричные светильники
- **Лофт** → треки, открытые лампочки, металлические плафоны
- **Скандинавский** → натуральные материалы, тёплый свет, простые формы
- **Современный** → LED светильники, диммирование, smart light

## Шаг 6: Не забудьте про диммирование

Диммеры позволяют менять яркость света под ситуацию:
- Вечер на диване → 30% яркости
- Чтение → 70% яркости
- Уборка → 100% яркости

Выбирайте диммируемые светильники и лампы для большей гибкости.

## Полезные ссылки

- [Люстры для гостиной](/catalog/lyustry)
- [Встраиваемые светильники](/catalog/vstraivaemye-svetilniki)
...
**Вопрос:** Какие способы доставки есть?

**Ответ:** Мы предлагаем:
- Курьерская доставка в Мозыре (1–2 дня)
- Курьерская доставка по Беларуси (2–5 дней)
- Самовывоз из магазина (бесплатно)
- Отправка почтой при весе до 5 кг

## Оплата

**Вопрос:** Можно ли оплатить по частям?

**Ответ:** Нет, оплата полной суммы требуется при оформлении. Но вы можете оплатить несколькими способами:
- Наличными при получении
- Картой при заказе
- Через ЕРИП
- Безналичным расчётом (только для организаций)

## Установка и консультация

**Вопрос:** Вы предоставляете услуги по установке?

**Ответ:** Прямо нет, но вы можете:
- Получить консультацию в магазине о монтаже
- Заказать рекомендованного электрика
- Найти мастера через объявления

## Возврат товара

**Вопрос:** Какой срок для возврата?

**Ответ:** 14 дней при условии сохранения товарного вида и упаковки. Дальше — через рекламацию с экспертизой.

## Гарантия

**Вопрос:** Что входит в гарантию?

**Ответ:** Гарантия производителя покрывает производственные дефекты. Не покрывает: механические повреждения, износ, неправильную установку.

## Совместимость

**Вопрос:** Какие лампы подходят для моего светильника?

**Ответ:** Смотрите на цоколь лампы (E27, E14, GU10 и т.д.). Мощность зависит от максимально допустимой в светильнике. Проверьте инструкцию.

**Вопрос:** Какой диммер выбрать для LED-лампы?

**Ответ:** LED-лампы требуют специального диммера, совместимого с LED. Обычные диммеры для ламп накаливания не подойдут.

## Покупка в интернете

**Вопрос:** Как я могу быть уверен в качестве товара?

**Ответ:** Все товары — оригинальные от производителей. Каждый товар проверяется перед отправкой. Гарантия производителя защищает ваше право на замену или возврат.

**Вопрос:** Смогу ли я посмотреть товар перед покупкой?
...
export const SEARCH_QUERIES = [
	...
	'люстра для натяжного потолка',
	'встраиваемые светильники гу10',
	'потолочные споты белые',
	'бра с выключателем',
	'напольный торшер',
	'офисное освещение',
