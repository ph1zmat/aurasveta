...
export type SeedPropertyDefinition = {
	/** Used as slug when creating the Property record */
	key: string
	name: string
	/** Pre-defined fixed options (will become PropertyValue records) */
	options?: string[]
}
...
export const PROPERTY_DEFINITIONS: SeedPropertyDefinition[] = [
	{ key: 'product_type', name: 'Тип товара', options: ['Люстра', 'Светильник', 'Трековая система', 'Бра', 'Спот', 'Настольная лампа', 'Уличный светильник', 'Торшер', 'Электротовар', 'Предмет интерьера', 'Лампочка'] },
	{ key: 'series', name: 'Серия' },
	{ key: 'style', name: 'Стиль', options: ['Классический', 'Современный', 'Минимализм', 'Лофт', 'Скандинавский', 'Ар-деко', 'Техно', 'Викторианский'] },
	{ key: 'color', name: 'Цвет' },
	{ key: 'material', name: 'Материал' },
	{ key: 'placement', name: 'Расположение', options: ['Потолок', 'Подвес', 'Стена', 'Стол', 'Пол', 'Улица', 'Трек', 'Встраиваемый', 'Декор'] },
	{ key: 'purpose', name: 'Назначение' },
	{ key: 'mounting_type', name: 'Тип монтажа', options: ['Накладной', 'Встраиваемый', 'Подвесной', 'На штанге', 'На стол', 'Напольный', 'Скрытый', 'На штыре'] },
	{ key: 'base_type', name: 'Цоколь', options: ['E14', 'E27', 'GU10', 'GU5.3', 'GX53', 'G9', 'G4', 'LED', '24V'] },
	{ key: 'lamp_count', name: 'Количество ламп' },
	{ key: 'power_watts', name: 'Мощность, Вт' },
	{ key: 'total_power_watts', name: 'Общая мощность, Вт' },
	{ key: 'luminous_flux_lm', name: 'Световой поток, лм' },
	{ key: 'color_temperature', name: 'Цветовая температура', options: ['2700K', '3000K', '3300K', '4000K', '4200K', '5500K'] },
	{ key: 'room_area_m2', name: 'Площадь освещения, м²' },
	{ key: 'ip_rating', name: 'Степень защиты', options: ['IP20', 'IP44', 'IP54', 'IP65'] },
	{ key: 'dimmable', name: 'Диммирование' },
	{ key: 'smart_control', name: 'Умное управление' },
	{ key: 'power_source', name: 'Источник питания', options: ['Сеть 220V', 'Солнечная батарея', 'Аккумулятор', '24V'] },
	{ key: 'grounding', name: 'Заземление' },
	{ key: 'usb_ports', name: 'USB-порты' },
	{ key: 'control_type', name: 'Тип управления' },
	{ key: 'lamp_type', name: 'Тип лампы', options: ['LED', 'Накаливания', 'Галогенная'] },
	{ key: 'shape', name: 'Форма', options: ['Груша', 'Шар', 'Свеча', 'Капсула', 'Рефлектор', 'Круг', 'Прямоугольник', 'Цилиндр'] },
	{ key: 'equivalent_power_watts', name: 'Эквивалент мощности, Вт' },
]
